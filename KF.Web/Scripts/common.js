...
function formItem_text(option) {
    ...
    $(div_form_item).addClass("ui-form-item ui-border-tb");
...
function formItem_Checkbox(option) {
    ...
    var div_form_item = document.createElement("div");
    $(div_form_item).addClass("ui-form-item ui-form-item-switch ui-border-tb");
    fragment.appendChild(div_form_item);

    var p = document.createElement("p");
    $(p).text(option.label).click(option.labelClick);
...
function formItem_Desc(option) {
    var p = pUI({ text: option.text });
    $(p).addClass("formItem-desc");
    return p;
}

function formItem_textSelect(option){
    var div_form_item = document.createElement("div");
    ...
    div_form_item.appendChild(text);

    var i = document.createElement("i");
    $(i).addClass("ui-icon-search").click(option.click);
    div_form_item.appendChild(i);
...
function list_imgUI(option) {
    var div_list_img = document.createElement("div");
    $(div_list_img).addClass("ui-list-img");

    var img = document.createElement("img");
    $(img).prop("src", "data:image/jqeg;base64," + option.imgData);
    div_list_img.appendChild(img);
...
function searchBox(option) {
    ...
    $(div_wrap).addClass("ui-searchbar-wrap ui-border-b");

    var div_searchBar = document.createElement("div");
    $(div_searchBar).addClass("ui-searchbar ui-border-radius");
    div_wrap.appendChild(div_searchBar);

    var div_search_input = document.createElement("div");
    $(div_search_input).addClass("ui-searchbar-input");
    div_searchBar.appendChild(div_search_input);

    var input = document.createElement("input");
    div_search_input.appendChild(input);

    var i_clear = document.createElement("i");
    $(i_clear).addClass("ui-icon-close").click(function () {
        $(input).val("");
    });
    div_searchBar.appendChild(i_clear);

    var btnCancel = document.createElement("button");
    $(btnCancel).addClass("ui-searchbar-cancel").text("搜索").click(function () {
        var val = $(input).val();
        option.click(val);
    });
    div_wrap.appendChild(btnCancel);
