...
function initProvince() {
    ...
    _province.addLoadObserver(showPageHeader);
}

function showPageHeader(value) {
    ...
    var h1 = kf.base.h1UI({ text: value.provinceName });
...
function initCities() {
    ...
    _cities.addLoadObserver(showCityListUI);
}

function showCityListUI(values) {
